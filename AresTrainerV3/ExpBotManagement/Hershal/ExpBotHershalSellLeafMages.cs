            ...
            while (_isExpBotRunning)
            {
                ...
                for (int i = 0; i < 4; i++)
                {
                    ...
                    if (i == 0)
                    {
                        ...
                        MoveToPosPlace.MoveAttackCollect(DirectionsEnum.Left, 1128494225, 1131207739, 1132673292, 1);
                    ...
                    {
                        ExpBotClass.ExpBotLog += $"current i {i}\n";
                        MoveToPosPlace.MoveAttackCollect(DirectionsEnum.Up, 1132673292, 1127580850, 1132749901, 1);
