...
namespace AresTrainerV3
{
    public static class TeleportValues
    {
        ...
        public static ValueTuple<int, int, int> PosEasternMiningTunnelEntrace = new ValueTuple<int, int, int>( 1105879974, 1129876799, 1076321776);
        ...
        public static Tuple<int, int, int> SacredLandsImpCave = new Tuple<int, int, int>(1129967491, 1142341254, 0);
